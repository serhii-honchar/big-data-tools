...
curl 'http://localhost:30090/nifi-api/processors/f6a719c6-0175-1000-0000-00003a21fa64/run-status' \
  ...
  --data-binary '{"revision":{"clientId":"017baa04-0176-1000-0574-aa87db9c6983","version":10},"state":"STOPPED","disconnectedNodeAcknowledged":false}' \
  --compressed ;
...
curl 'http://localhost:30090/nifi-api/processors/d87e35e3-0175-1000-ffff-ffffc883a25b/run-status' \
  ...
  -H 'Accept-Language: en-US,en;q=0.9' \
  -H 'Cookie: Idea-1e00aa=f726b8fa-080c-486f-8525-99f7a2437840' \
  --data-binary '{"revision":{"clientId":"017baa04-0176-1000-0574-aa87db9c6983","version":9},"state":"STOPPED","disconnectedNodeAcknowledged":false}' \
  --compressed ;
